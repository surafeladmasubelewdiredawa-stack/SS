...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; user-select: none; }
        ...
        @media (max-width: 480px) { .progress-container { width: 50px; } .footer-info { font-size: 0.75rem; max-width: 40%; } .controls { padding: 3px 10px; gap: 4px; } .page-num { font-size: 0.8rem; min-width: 15px; } }
    </style>
</head>
<body>
